...
- [anti-ai-prompts.md](references/anti-ai-prompts.md)：**防 AI 感写作提示词大全**——汇总活人感写作规范（living_writing）+ 写作硬约束 + AI 指纹清单 + 硬禁令清单 + 文体骨架化操作表 + Sepia 三遍协议；含 4 个可直接粘贴的提示词模板（写作/润色/终检/检测不过重写）。
